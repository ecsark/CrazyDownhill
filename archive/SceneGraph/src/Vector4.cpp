...
Vector4::Vector4(double c0, double c1, double c2)
{
    c[0] = c0;
    c[1] = c1;
    c[2] = c2;
...
Vector4::Vector4(double c0, double c1, double c2, double c3)
{
    c[0] = c0;
    c[1] = c1;
    c[2] = c2;
...
void Vector4::setCoordinates(double c0, double c1, double c2, double c3)
{
    c[0] = c0;
    c[1] = c1;
    c[2] = c2;
...
double* Vector4::getCoordinates(void)
{
    return c;
}

void Vector4::setCoordinate(int dim, double value)
{
    assert(dim>=0 && dim<=3);
    c[dim] = value;
}
...
const double Vector4::getCoordinate(int dim)
{
    assert(dim>=0 && dim<=3);
    return c[dim];
}

double& Vector4::operator [] (int dim)
{
    assert(dim>=0 && dim<=3);
    double &k = c[dim];
    return k;
